<template>
  <div class="">
    <div class="logo-container">
      <div class="logo text-4xl text-center mt-12 flex justify-center items-center lg:text-5xl">
        <img class="timer-logo" src="@/assets/stopwatch-svgrepo-com.svg" alt="">
        <span class="ml-2 font-extralight">Fitness</span> <span class="ml-1"> <span
            style="color:#6c63ff">Timer</span></span>
      </div>
    </div>
    <div class=" login-container flex min-h-full flex-col justify-center py-12 px-6 sm:px-6 lg:px-8">
      <div class="xl:grid xl:grid-cols-3 xl:items-center">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md sm:border sm:border-gray-200 sm:py-6 sm:shadow-2xl sm:rounded-md">
            ...
            <div class="mt-6 grid grid-cols-2 gap-3">
              ...
              <div>
                <a href="#"
                  ...
                  <svg class="h-5 w-5" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" fill="#6b7280">
                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                    <g id="SVGRepo_iconCarrier">
                      <title>google [#6b7280]</title>
                      <desc>Created with Sketch.</desc>
                      <defs> </defs>
                      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Dribbble-Light-Preview" transform="translate(-300.000000, -7399.000000)" fill="#6b7280">
